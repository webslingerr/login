...
func Load() Config {
	...
	cfg.ServerPort = cast.ToString(getOrReturnDefaultValue("HTTP_PORT", ":5000"))
	...
	cfg.PostgresDatabase = cast.ToString(getOrReturnDefaultValue("POSTGRES_DATABASE", "userbase"))
